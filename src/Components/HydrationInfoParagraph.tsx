...
export class HydrationInfoParagraph extends React.Component<IHydrationInfoProps>{
  public render() {
    ...
    return (<View>
      <Text style={{ fontSize: 24, textAlign: 'center', marginTop: 4 }}>{`Add ${waterWeightToMatchDesiredTargetHydration.toFixed(0)}g water to ${flourWeight}g flour and ${leavenWeight}g leaven (${leavenHydration}% hydr.) in order to reach target hydr. of ${desiredTargetHydration}%`}
      </Text>
    </View>
    );
  }
